...
var (
	...
	ErrBotNotAuthorized   = errors.New("it looks like I don't have access to any page or the page contains some children, ensure running the command /register and select the pages you want me to access to")
)
