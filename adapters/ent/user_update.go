...
// SetNillableNotionToken sets the "notion_token" field if the given value is not nil.
func (uu *UserUpdate) SetNillableNotionToken(s *string) *UserUpdate {
	if s != nil {
		uu.SetNotionToken(*s)
	}
	return uu
...
// SetNotionToken sets the "notion_token" field.
func (uuo *UserUpdateOne) SetNotionToken(s string) *UserUpdateOne {
	uuo.mutation.SetNotionToken(s)
	return uuo
}
